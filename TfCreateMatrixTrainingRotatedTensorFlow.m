...
% 
function [trainTensorFlow,testTensorFlow,tensorFlow,idxTest] = TfCreateMatrixTrainingRotatedTensorFlow()
  ...
  csvwrite ("tensorFlow/trainRotatedTensorFlow.csv", trainTensorFlow);
  csvwrite ("tensorFlow/testRotatedTensorFlow.csv", testTensorFlow);