function [apRobot,robot,xOut,yOut,hOut,distance] = ApLookForClosestAvailability(apRobot,robot,xIn,yIn,heading,debugOn)
% no longer used and working
...
%}
  ...
  xIn=floor(xIn);
  yIn=floor(yIn);
	RobotBackWidth =apGet(apRobot,"iRobotWidth")/2;
  gapSize=apGet(apRobot,"stepSize");
  RobotFrontWidth=apGet(apRobot,"iRobotFrontWidth")/2;
